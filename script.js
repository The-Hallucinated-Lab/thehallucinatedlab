...
const NAV_ICONS = {
  ...
  /* A closed volume seen spine-on, with three ruled lines cut out of the
     ...
     read as one section split in half. The three inner rectangles wind
     against the outer one on purpose — same trick the SLM chip uses, and
     the only way to get a hole out of a single filled path. */
  'dictionary.html': 'M4 3.5h3v17H4zM8.5 3.5H20v17H8.5zm2 4v2h7v-2zm0 4v2h7v-2zm0 4v2h4v-2z',
