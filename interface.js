...
(function () {
  ...
  async function runToolTurn(text) {
    ...
    if (!window.THL.toolkit.runsIn(tool, 'browser')) {
      ...
      /* Some of these have a runner on their own page even though this
         chat cannot dispatch them - the manifest says which. Send people
         there rather than to a terminal they may not need. */
